...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_blindcontroller p_blindcontroller;
        ...
        public static SteamVR_Input_ActionSet_blindcontroller blindcontroller
        {
            get
            {
                return SteamVR_Actions.p_blindcontroller.GetCopy<SteamVR_Input_ActionSet_blindcontroller>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_blindcontroller = ((SteamVR_Input_ActionSet_blindcontroller)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_blindcontroller>("/actions/blindcontroller")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.blindcontroller};
        }
    }
}
